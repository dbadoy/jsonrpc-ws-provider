...
import { ChunkResponseParser } from '../src/utils/chunk_response_parser';
...
describe('chunk_response_parser', () => {
    ...
    it('parse response with last chunk mechanism', () => {
        parser.parseResponse('{"jsonrpc":"2.0","id":"96aa3f13-077c-4c82-a64a-64b8626f8192","result":"0x141414141');
